...
interface AppendPromptNodeProps {
  data: {
    textToAppend?: string;
  };
  selected?: boolean;
...
export const AppendPromptNode = memo(({ data, selected }: AppendPromptNodeProps) => {
  return (
    <div 
    ...
    >
      ...
      <div className="p-3 bg-[#f0f0f0]">
        <div className="text-[10px] text-[#606060] mb-1">APPEND:</div>
        <div className="text-[11px] text-[#404040] min-h-[40px]">
          {data.textToAppend || <span className="text-[#909090]">Enter text...</span>}
        </div>
      </div>
...
AppendPromptNode.displayName = 'AppendPromptNode';
